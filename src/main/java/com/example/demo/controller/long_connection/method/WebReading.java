 ...
 */
@Component
public class WebReading extends Thread{
    ...
    public WebReading(SimpMessagingTemplate template, int num, String[] attributes, String uuid, ArrayBlockingQueue<String> arrayBlockingQueue){
    ...
    public WebReading(SimpMessagingTemplate template, int num, String uuid, ArrayBlockingQueue<String> arrayBlockingQueue){
        this.template=template;
        this.num=num;
        this.uuid=uuid;
        this.arrayBlockingQueue=arrayBlockingQueue;
